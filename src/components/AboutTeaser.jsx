        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:order-1">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed text-pretty">
              HAAPNET works directly with communities across Kenya to build sustainable livelihoods, strengthen local
              capacity, and create lasting positive change. Our approach focuses on empowering local voices and
              supporting grassroots initiatives.
            </p>

            <p className="text-lg text-gray-700 mb-8 leading-relaxed text-pretty">
              Through skills training, business support, and community development projects, we help communities become
              self-reliant and resilient. Every program is designed with local input and ownership at its core.
            </p>
          ...
          <motion.div variants={itemVariants} className="lg:order-2">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://via.placeholder.com/600x400?text=Community+Empowerment"
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-700 text-sm">
                  Working with 50+ communities across Kenya to build sustainable futures together.
                </p>
              </div>
            </div>
          </motion.div>
